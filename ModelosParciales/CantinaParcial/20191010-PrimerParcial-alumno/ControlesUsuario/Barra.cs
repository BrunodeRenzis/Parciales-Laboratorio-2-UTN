...
namespace ControlCantina
{
    public partial class Barra : UserControl
    {
        ...
        public Cantina SetCantina {
            ...
            {
                this.cantina = value;
                this.cantina.Botellas.Add(new Cerveza(2000, 2000, "Patagonia", Botella.Tipo.Vidrio));
                this.cantina.Botellas.Add(new Agua(2000, 2000, "Villavicencio"));
                this.cantina.Botellas.Add(new Cerveza(2000,2000, "Imperial IPA", Botella.Tipo.Plastico));
        ...
        private void ServirCopa(object sender, EventArgs e)
        {
            ...
            float cantidadServida = botella.ServirMedida();
            if (botella.ServirMedida() > 0)
                ...
                MessageBox.Show(string.Format("No queda más líquido"));
